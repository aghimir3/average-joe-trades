 ...
 *
 * Official Google "G" logo as an SVG component.
 * Used for Google OAuth sign-in buttons.
 *
 * @example
 ...
 *
 * Renders the official Google brand colors:
 * - Blue (#4285F4)
 * - Green (#34A853)
 * - Yellow (#FBBC05)
 * - Red (#EA4335)
 *
 * @param props - SVG attributes including className
 */
